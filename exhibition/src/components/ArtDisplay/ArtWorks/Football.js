...
class Football extends React.Component {
    animate() {
        ...
        const rightLeg = SVG("#rightLeg");
        leftLeg.timeline().finish();
        rightLeg.timeline().finish();
        ball.timeline().finish();
        ...
        rightLeg
            ...
            .transform({ rotate: 0 });
        leftLeg
            .animate({ duration: 200, delay: 200 })
            .transform({ rotate: -10, origin: "top-left" })
            .animate({ duration: 200 })
            .transform({ rotate: 0 });
        ball.animate({ duration: 300, delay: 400 })
            .transform({
                translateY: -5,
            })
        ...
        rightPow
            .animate({ duration: 200, delay: 400 })
