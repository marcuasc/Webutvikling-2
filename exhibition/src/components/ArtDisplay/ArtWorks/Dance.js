...
class Dance extends React.Component {
    animate() {
        const strokes = SVG("#strokes");
        const person1 = SVG("#person1");
        const person2 = SVG("#person2");
        const person3 = SVG("#person3");
        const person4 = SVG("#person4");
        const person5 = SVG("#person5");
        strokes.timeline().finish();
        person1.timeline().finish();
        person2.timeline().finish();
        person3.timeline().finish();
        person4.timeline().finish();
        person5.timeline().finish();
        strokes
        ...
        person1
            .animate({ duration: 500 })
            .transform({ translateY: -5, rotate: -5 })
            .animate({ duration: 500 })
            .transform({ translateY: 0, rotate: 0 });
        person2
            .animate({ duration: 500 })
            .transform({ translateY: -6, rotate: 4 })
            .animate({ duration: 500 })
            .transform({ translateY: 0, rotate: 0 });
        person3
            .animate({ duration: 500 })
